...
cp -rv ${GOBUILD_CAYMAN_ANTREA_ROOT}/{add-on,photon,ubuntu}  "${cayman_antrea_publish}/TKGS"
mkdir -p "${cayman_antrea_publish}/TKGM"
cp -rv ${GOBUILD_CAYMAN_ANTREA_ROOT}/{lin64,windows-advanced}  "${cayman_antrea_publish}/TKGM"

mkdir -p "${cayman_antrea_publish}/standard-release"
cp -rv ${GOBUILD_CAYMAN_ANTREA_ROOT}/antrea-windows-standard-*.zip  "${cayman_antrea_publish}/standard-release"
