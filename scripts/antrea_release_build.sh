...
pushd "${PUBLISH_DIR}/"
curl https://packages.vcfd.broadcom.net/artifactory/nsx-ujo-local/antrea/VMware-Antrea-${RELEASE_VERSION}-ODP.tar.gz > VMware-Antrea-${RELEASE_VERSION}-ODP.tar.gz
popd
