...
deb-src http://build-artifactory.eng.vmware.com/debian-remote bullseye main
deb-src http://build-artifactory.eng.vmware.com/debian-remote bullseye-updates main
deb-src http://build-artifactory.eng.vmware.com/debian-security-remote bullseye-security main
deb http://build-artifactory.eng.vmware.com/debian-remote bullseye main
deb http://build-artifactory.eng.vmware.com/debian-remote bullseye-updates main
deb http://build-artifactory.eng.vmware.com/debian-security-remote bullseye-security main
EOF
apt update
...
cd osstpclients
wget https://artifactory.eng.vmware.com/artifactory/osm-client-generic-local/osstpclients3_2023-05-18.zip
