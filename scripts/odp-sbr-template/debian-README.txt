This directory contains disclosure of BaseOS packages of Debian.
...
a "Debian" system.
You can just install the debian system from image/iso downloaded from https://www.debian.org.

Install the dpkg-dev and build-essentials packages. Find the package you want
to build in the "debian" directory. Usually it's PackageName.tar
