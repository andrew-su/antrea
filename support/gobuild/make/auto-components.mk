...
GOBUILD_PYTHON := $(TCROOT)/win32/python-2.4.3/python.exe
else
...
GOBUILD_PYTHON := $(TCROOT)/lin32/python-2.4.3/bin/python
endif
...
GOBUILD_SPECINFO_PY ?= $(MAINSRCROOT)/support/gobuild/specs/$(GOBUILD_TARGET).py
...
ifdef GOBUILD_REMOTECACHE_LINUX_DIR
# Example: /build/current/compcache/gobuild/official
GOBUILD_DEPS_CMD += --compcache.linux=$(GOBUILD_REMOTECACHE_LINUX_DIR)
endif
ifdef GOBUILD_REMOTECACHE_WIN32_DIR
# Example: //build-current/current/compcache/gobuild/official
GOBUILD_DEPS_CMD += --compcache.win32=$(GOBUILD_REMOTECACHE_WIN32_DIR)
endif
...
ifdef GOBUILD_AUTO_COMPONENTS_BACKEND
GOBUILD_DEPS_CMD += --backend=$(GOBUILD_AUTO_COMPONENTS_BACKEND)
endif
ifdef GOBUILD_AUTO_COMPONENTS_SERVER
GOBUILD_DEPS_CMD += --server=$(GOBUILD_AUTO_COMPONENTS_SERVER)
endif
...
$(GOBUILD_SPECINFO_MK): $(GOBUILD_SPECINFO_PY) $(GOBUILD_CREATE_SPECINFO)
	@echo "** Generating $@ (please ignore any above error about this file not existing)"
