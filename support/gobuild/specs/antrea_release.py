ANTREA_INTERWORKING_BRANCH = "release-0.5"
...
CAYMAN_ANTREA_BRANCH = "vmware-1.5.0+vmware.2"
...
CAYMAN_ANTREA_OPERATOR_FOR_KUBERNETES_BRANCH = "vmware-1.5.0+vmware.2-advanced"
