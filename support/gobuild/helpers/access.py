# Copyright (c) 2009 VMware, Inc.  All rights reserved. -- VMware Confidential
"""
...
def MakeAccessTarget(name, cls):
    class AccessTarget(cls):
        ...
        def GetCommands(self, hosttype):
            ...
            build, preceeded by a command to prepare the access build state and
            followed by commands to find accessed files in each source
