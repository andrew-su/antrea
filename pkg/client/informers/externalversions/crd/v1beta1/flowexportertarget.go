...
type FlowExporterTargetInformer interface {
	...
	Lister() v1beta1.FlowExporterTargetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1beta1().FlowExporterTargets().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1beta1().FlowExporterTargets().Watch(context.TODO(), options)
			},
		},
		&crdv1beta1.FlowExporterTarget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *flowExporterTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdv1beta1.FlowExporterTarget{}, f.defaultInformer)
}

func (f *flowExporterTargetInformer) Lister() v1beta1.FlowExporterTargetLister {
	return v1beta1.NewFlowExporterTargetLister(f.Informer().GetIndexer())
}
