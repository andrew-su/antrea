...
// TierEntitlementBindingListerExpansion allows custom methods to be added to
// TierEntitlementBindingLister.
type TierEntitlementBindingListerExpansion interface{}
