...
func (f *featureNetworkPolicy) dryRunFlows() []binding.Flow {
	...
	genFlows := func(metricTable *Table, antreaTable *Table, defaultTable *Table) []binding.Flow {
		return []binding.Flow{
	...
	flows = append(flows, genFlows(EgressMetricTable, AntreaPolicyEgressRuleTable, EgressRuleTable)...)
	flows = append(flows, genFlows(IngressMetricTable, AntreaPolicyIngressRuleTable, IngressRuleTable)...)
