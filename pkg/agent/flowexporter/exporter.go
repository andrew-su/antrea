...
func (fe *FlowExporter) onNewTarget(obj interface{}) {
	...
	klog.V(logLevel).InfoS("DEBUG: Received new FlowExporterTarget", "resource", klog.KObj(targetRes))
...
func (fe *FlowExporter) onTargetUpdate(oldObj interface{}, newObj interface{}) {
	...
	klog.V(logLevel).InfoS("DEBUG: FlowExporterTarget updated", "old", klog.KObj(oldTargetRes), "new", klog.KObj(targetRes))
...
func (fe *FlowExporter) onTargetDelete(obj interface{}) {
	targetRes := obj.(*api.FlowExporterTarget)
	klog.V(logLevel).InfoS("DEBUG: FlowExporterTarget deleted", "resource", klog.KObj(targetRes))
